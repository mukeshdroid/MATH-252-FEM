...
pause -1
set title "Input Data file for Verification-I - 2D structural frame analysis (N m Kg) \nanalysis file: ./../tests/verify1.3dd   deflection exaggeration: 5.0   load case 2 of 2 "
unset clip; 
set clip one; set clip two
set xyplane 0 
