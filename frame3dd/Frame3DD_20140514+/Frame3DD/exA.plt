...
set clip one; set clip two
set xyplane 0 
  plot '/tmp/exA-msh' u 2:3 t 'undeformed mesh' w lp lw 1 lt 5 pt 6, '/tmp/exA-mshf.002' u 1:2 t 'load case 2 of 2' w l lw 1 lt 3
# splot '/tmp/exA-msh' u 2:3:4 t 'load case 2 of 2' w lp  lw 1 lt 5 pt 6, '/tmp/exA-mshf.002' u 1:2:3 t 'load case 2 of 2' w l lw 1 lt 3
